...
(SELECT MAX(SEQUENCE#) LOG_ARCHIVED FROM GV$ARCHIVED_LOG WHERE DEST_ID in (1,2) AND ARCHIVED='YES'),
(SELECT MAX(SEQUENCE#) LOG_APPLIED FROM GV$ARCHIVED_LOG WHERE DEST_ID in (1,2) AND APPLIED='YES');
=========================================================================================================================================
