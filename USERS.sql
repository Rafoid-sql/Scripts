...
SELECT /*+ PARALLEL 6 */ INST_ID AS "INST", SESSION_ID AS "SESSION", DB_USER, OS_USER, OS_HOST, OS_PROCESS, TERMINAL, RETURNCODE, EXTENDED_TIMESTAMP
FROM GV$XML_AUDIT_TRAIL
WHERE RETURNCODE IN (1017,28000) 
--WHERE RETURNCODE IN (1017) 
AND DB_USER='CENTIVIA_AT' 
