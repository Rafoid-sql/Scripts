...
=========================================================================================================================================
-- Check usernames object count:
WITH ALL_OWNERS AS (
  SELECT 'MRENKEN1' AS OWNER FROM DUAL UNION ALL
  SELECT 'USHARMA5' AS OWNER FROM DUAL UNION ALL
  SELECT 'MKANDEK1' AS OWNER FROM DUAL UNION ALL
  SELECT 'ZARORA1' AS OWNER FROM DUAL UNION ALL
  SELECT 'KMALAVA1' AS OWNER FROM DUAL UNION ALL
  SELECT 'RROJO4' AS OWNER FROM DUAL UNION ALL
  SELECT 'SUPPUTE1' AS OWNER FROM DUAL UNION ALL
  SELECT 'MLAXMAN1' AS OWNER FROM DUAL UNION ALL
  SELECT 'ESTICKE1' AS OWNER FROM DUAL UNION ALL
  SELECT 'SDUDIPA1' AS OWNER FROM DUAL UNION ALL
  SELECT 'TCHULI1' AS OWNER FROM DUAL UNION ALL
  SELECT 'SBROWN103' AS OWNER FROM DUAL UNION ALL
  SELECT 'VMELAM1' AS OWNER FROM DUAL UNION ALL
  SELECT 'BHAYCRA1' AS OWNER FROM DUAL UNION ALL
  SELECT 'PBAGWE1' AS OWNER FROM DUAL UNION ALL
  SELECT 'VSHARMA90' AS OWNER FROM DUAL UNION ALL
  SELECT 'SGANNAM1' AS OWNER FROM DUAL UNION ALL
  SELECT 'MSAPRE1' AS OWNER FROM DUAL UNION ALL
  SELECT 'SBALASUBRAMANI' AS OWNER FROM DUAL UNION ALL
  SELECT 'BHALICA' AS OWNER FROM DUAL UNION ALL
  SELECT 'GRAJEND1' AS OWNER FROM DUAL UNION ALL
  SELECT 'SBANERJ20' AS OWNER FROM DUAL UNION ALL
  SELECT 'JBLOOM3' AS OWNER FROM DUAL UNION ALL
  SELECT 'MGOYAL3' AS OWNER FROM DUAL UNION ALL
  SELECT 'NKAMTHE1' AS OWNER FROM DUAL UNION ALL
  SELECT 'VNARAYA11' AS OWNER FROM DUAL UNION ALL
  SELECT 'SROEPE1' AS OWNER FROM DUAL UNION ALL
  SELECT 'SAGARWA66' AS OWNER FROM DUAL UNION ALL
  SELECT 'PEATHAK1' AS OWNER FROM DUAL UNION ALL
  SELECT 'SVERGHE1' AS OWNER FROM DUAL UNION ALL
  SELECT 'OCHAUDH4' AS OWNER FROM DUAL UNION ALL
  SELECT 'BDHANAS1' AS OWNER FROM DUAL UNION ALL
  SELECT 'SVELEKA1' AS OWNER FROM DUAL UNION ALL
  SELECT 'BBROSSE1' AS OWNER FROM DUAL UNION ALL
  SELECT 'SDUBEY25' AS OWNER FROM DUAL UNION ALL
  SELECT 'SVEERAM1' AS OWNER FROM DUAL UNION ALL
  SELECT 'TPOLOJU1' AS OWNER FROM DUAL UNION ALL
  SELECT 'LCHIMIR2' AS OWNER FROM DUAL UNION ALL
  SELECT 'JSAMSOU' AS OWNER FROM DUAL UNION ALL
  SELECT 'DVICKSO' AS OWNER FROM DUAL UNION ALL
  SELECT 'SRAVICH4' AS OWNER FROM DUAL
)
SELECT AO.OWNER, COUNT(DO.OWNER) AS OBJECT_COUNT
FROM ALL_OWNERS AO
LEFT JOIN DBA_OBJECTS DO ON AO.OWNER = DO.OWNER
GROUP BY AO.OWNER
ORDER BY AO.OWNER;
=========================================================================================================================================
...
SELECT /*+ PARALLEL 4 */ INST_ID AS "INST", SESSION_ID AS "SESSION", DB_USER, OS_USER, OS_HOST, OS_PROCESS, TERMINAL, RETURNCODE, EXTENDED_TIMESTAMP
FROM GV$XML_AUDIT_TRAIL
WHERE RETURNCODE IN (1017,28000) 
--WHERE RETURNCODE IN (1017) 
AND DB_USER='PAHUJA1' 
AND EXTENDED_TIMESTAMP > (SYSTIMESTAMP-2)
...
COL EXTENDED_TIMESTAMP FOR A35
COL TERMINAL FOR A15
SELECT /*+ PARALLEL 4 */ SESSION_ID AS "SESSION", DB_USER, OS_USER, OS_HOST, OS_PROCESS, TERMINAL, RETURNCODE, EXTENDED_TIMESTAMP
FROM V$XML_AUDIT_TRAIL
WHERE RETURNCODE IN (1017,28000)  
AND DB_USER='BPMS_QL02_ADMIN' 
