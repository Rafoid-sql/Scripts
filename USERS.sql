...
SELECT INST_ID INST, SESSION_ID, DB_USER, OS_USER, OS_HOST, OS_PROCESS, TERMINAL, RETURNCODE, EXTENDED_TIMESTAMP
...
--SELECT USERNAME, ACCOUNT_STATUS, CREATED, EXPIRY_DATE, LOCK_DATE, PROFILE FROM DBA_USERS WHERE USERNAME IN ('CDE_QLAB02');
--SELECT USERNAME, ACCOUNT_STATUS, CREATED, EXPIRY_DATE, PROFILE FROM DBA_USERS WHERE USERNAME IN ('HBHARGA1');
=========================================================================================================================================
...
SELECT USERNAME, ACCOUNT_STATUS, CREATED, EXPIRY_DATE, LOCK_DATE, PROFILE, PASSWORD_CHANGE_DATE FROM DBA_USERS WHERE USERNAME = UPPER('&USER');
=========================================================================================================================================
...
WHERE P.OBJECT_OWNER = 'CKALRA1' 
--AND P.OPERATION LIKE 'TABLE%' 
AND P.SQL_ID = S.SQL_ID 
AND P.TIMESTAMP = (SELECT MAX(TIMESTAMP) FROM DBA_HIST_SQL_PLAN P2 WHERE P.OBJECT_NAME = P2.OBJECT_NAME AND OBJECT_OWNER = P.OBJECT_OWNER)
ORDER BY 4,1;
=========================================================================================================================================
...
COL OPTIONS FOR A30
COL OBJ_NAME FOR A40
SELECT DISTINCT P.OBJECT_NAME OBJ_NAME, P.OPERATION OPERATION, COUNT(1) IDX_USG_CNT 
FROM DBA_HIST_SQL_PLAN P, DBA_HIST_SQLSTAT S 
WHERE P.OBJECT_OWNER = 'SVC_PRD_POSR_GERYON' 
AND P.OPERATION LIKE 'TABLE%' 
AND P.SQL_ID = S.SQL_ID 
GROUP BY P.OBJECT_OWNER, P.OBJECT_NAME, P.OPERATION, P.TIMESTAMP 
ORDER BY 3,1;
=========================================================================================================================================
