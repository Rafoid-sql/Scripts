...
COL PROFILE FOR A30
SELECT USERNAME,ACCOUNT_STATUS,PROFILE,CREATED,EXPIRY_DATE FROM DBA_USERS WHERE USERNAME IN ('SVC_QAT_FACT_FM');
=========================================================================================================================================
-- PASSWORD CHANGE
...
AND C.USERNAME IN ('RTOADM','SVC_PRD_COL_PA_RECON','ADMUSR','ADM_USER','APPADM','SVC_PRD_COL_MS_COMP','PMADM','ADM_COLLECTIONS_PARECON','ADM_COLL_READONLY','CHUB_CDES_USER','REPHUB ADM_USER','SVC_PRD_COL_SAM_COMP','INFAWADM','SVC_PRD_REPHUB_ADM')
...
AND P.OBJECT_OWNER IN ('RTOADM','SVC_PRD_COL_PA_RECON','ADMUSR','ADM_USER','APPADM','SVC_PRD_COL_MS_COMP','PMADM','ADM_COLLECTIONS_PARECON','ADM_COLL_READONLY','CHUB_CDES_USER','REPHUB ADM_USER','SVC_PRD_COL_SAM_COMP','INFAWADM','SVC_PRD_REPHUB_ADM') 
...
AND A.SAMPLE_TIME >= TRUNC(SYSDATE) - 60
...
SELECT INST_ID, SESSION_ID, DB_USER, OS_USER, OS_HOST, OS_PROCESS, TERMINAL, RETURNCODE, EXTENDED_TIMESTAMP
