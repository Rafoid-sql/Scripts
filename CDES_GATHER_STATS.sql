...
SET TERMOUT ON
SPOOL '/home/oracle/cde_gather_table_stats_&today..log'
=========================================================================================================================================
SELECT INSTANCE_NAME, HOST_NAME, SYSDATE FROM V$INSTANCE;
=========================================================================================================================================
SELECT TABLE_OWNER AS "OWNER", TABLE_NAME,/*PARTITION_NAME, SUBPARTITION_NAME,*/ INSERTS, UPDATES, DELETES, TIMESTAMP, TRUNCATED /*,DROP_SEGMENTS*/
FROM DBA_TAB_MODIFICATIONS 
WHERE TABLE_OWNER='CDE'
AND TABLE_NAME IN (
'STG_BAN_EVENTS',
'TU_CREDIT_SCORE',
