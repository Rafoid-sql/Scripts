...
SELECT 'datafile' AS TYPE, NAME, ROUND(BYTES/1048576,2) AS MBYTES, BLOCKS, BLOCK_SIZE FROM V$DATAFILE where NAME like LOWER('%SYSAUX%') 
UNION ALL
...
SELECT 'DATAFILE' AS TYPE, NAME, ROUND(BYTES/1048576,2) AS MBYTES FROM V$DATAFILE WHERE NAME LIKE LOWER('%DUEDATE_DATA_BACKUP%');
COL TYPE FOR A15
COL NAME FOR A60
COL MBYTES FOR 999999999
...
and a.tablespace_name='CDE_DUEDATE_DATA'
