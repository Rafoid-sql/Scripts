...
echo "|---------------|-----------------------------------------------------------------------------------|"
echo "|backup_ctrl_spf|Backup Controlfile as (Trace/RMAN BKP), Backup SPFILE and Generate AWR for full day|"
...
echo "|               |modified to get the killing criteria match your requirements.                      |"
echo "|---------------|-----------------------------------------------------------------------------------|"
...
echo "|               |This link will show you how to use this script:                                    |"
echo "|               |http://dba-tips.blogspot.ae/2017/11/shell-script-to-check-lag-sync-status.html     |"
echo " --------------------------------------------------------------------------------------------------- "
echo ""
echo "***************************************"
echo "Thanks for using DBA BUNDLE V4.1,"
