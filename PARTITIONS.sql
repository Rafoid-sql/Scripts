...
SELECT OWNER, INDEX_NAME, INDEX_TYPE, TABLE_OWNER, COMPRESSION, STATUS FROM DBA_INDEXES WHERE TABLE_OWNER = 'CERTO2_EXTRACT' AND STATUS <> 'VALID' ORDER BY 2;

-- Check unusable index partitions
SELECT INDEX_OWNER,INDEX_NAME,PARTITION_NAME,SUBPARTITION_COUNT,TABLESPACE_NAME,STATUS FROM DBA_IND_PARTITIONS WHERE INDEX_OWNER='CERTO2_EXTRACT' AND STATUS='UNUSABLE';
