...
PROGRAM, L.TYPE TP, LMODE LM, REQUEST RQ, BLOCK BL, CTIME
...
SELECT DISTINCT 
--L.OBJECT_ID, 
S.INST_ID AS "INST", L.SESSION_ID || ',' || S.SERIAL# AS "SESSION", L.OS_USER_NAME AS "OS_USER", S.USERNAME, O.OBJECT_NAME AS "OBJECT", S.SQL_ID, MACHINE, C.COMMAND_NAME AS "COMMAND", 
CASE 
    WHEN S.STATUS = 'ACTIVE' THEN 'A'
    WHEN S.STATUS = 'INACTIVE' THEN 'I'
    ELSE 'O'
END AS "STATUS", TO_CHAR(S.LOGON_TIME, 'MMDDYY-HH24:MI:SS') AS "LOGON", TO_CHAR(S.SQL_EXEC_START, 'MMDDYY-HH24:MI:SS') AS "START", S.BLOCKING_SESSION AS "BLK_SESS", S.WAIT_CLASS, S.SECONDS_IN_WAIT AS "WAIT"
