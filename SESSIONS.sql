...
--AND STATUS = 'ACTIVE'
AND SQL_TEXT LIKE '%RIS_UDMF_RECON_TRANS_ID_PROCESS%'
...
SELECT DISTINCT 
--L.OBJECT_ID, 
S.INST_ID AS "INST", L.SESSION_ID || ',' || S.SERIAL# AS "SESSION", L.OS_USER_NAME AS "OS_USER", S.USERNAME AS "DB_USER", O.OBJECT_NAME AS "OBJECT", S.SQL_ID, MACHINE, C.COMMAND_NAME AS "COMMAND", 
