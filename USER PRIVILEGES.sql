...
<<<<<<< Updated upstream
<<<<<<< Updated upstream
SELECT 'GRANT INSERT,UPDATE,DELETE ON '||'"'||OWNER||'"'||'.'||'"'||OBJECT_NAME||'"'|| ' TO SRAJESH5;' FROM DBA_OBJECTS WHERE OBJECT_TYPE IN ('TABLE','VIEW') AND OWNER='SVC_QAT_ADM_QLAB04';
SELECT 'GRANT SELECT ON '||'"'||OWNER||'"'||'.'||'"'||OBJECT_NAME||'"'|| ' TO ROLE_SCH_LOGISTICS_RECON_RO;' FROM DBA_OBJECTS WHERE OBJECT_TYPE IN ('TABLE','VIEW') AND OWNER='SCH_LOGISTICS_RECON';
SELECT 'GRANT SELECT ON '||'"'||OWNER||'"'||'.'||'"'||OBJECT_NAME||'"'|| ' TO SDAMERL1;' FROM DBA_OBJECTS WHERE OBJECT_TYPE IN ('TABLE') AND OWNER='UDMF_UI';
SELECT 'GRANT SELECT ON '||'"'||OWNER||'"'||'.'||'"'||OBJECT_NAME||'"'|| ' TO ROLE_SVC_PRD_APM0101699_RO;' FROM DBA_OBJECTS WHERE OBJECT_TYPE IN ('TABLE','VIEW') AND OWNER='SVC_PRD_APM0101699';
SELECT 'GRANT EXECUTE,DEBUG ON '||'"'||OWNER||'"'||'.'||'"'||OBJECT_NAME||'"'|| ' TO SRAJESH5;' FROM DBA_OBJECTS WHERE OBJECT_TYPE IN ('PROCEDURE') AND OWNER='SVC_QAT_ADM_QLAB04';
SELECT 'GRANT EXECUTE,DEBUG ON '||'"'||OWNER||'"'||'.'||'"'||OBJECT_NAME||'"'|| ' TO SRAJESH5;' FROM DBA_OBJECTS WHERE OBJECT_TYPE IN ('PROCEDURE','PACKAGE','PACKAGE BODY','FUNCTION') AND OWNER='SVC_QAT_ADM_QLAB04';
SELECT 'GRANT SELECT,INSERT,UPDATE,DELETE ON '||'"'||OWNER||'"'||'.'||'"'||OBJECT_NAME||'"'|| ' TO SRAJESH5;' FROM DBA_OBJECTS WHERE OBJECT_TYPE IN ('TABLE') AND OWNER='SVC_QAT_ADM_QLAB04';
SELECT 'GRANT SELECT ON '||'"'||OWNER||'"'||'.'||'"'||OBJECT_NAME||'"'|| ' TO ROLE_IDM_USER_INFO_RO;' FROM DBA_OBJECTS WHERE OBJECT_TYPE IN ('TABLE') AND OWNER='IDM_USER_INFO';
