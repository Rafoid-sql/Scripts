...
export RMANREPORTS=/home/oracle/scripts/bin/rman_reports/solus_crosscheck_$VDATE.log

$ORACLE_HOME/bin/rman <<EOF
connect target /;
SPOOL log to '/home/oracle/scripts/bin/rman_reports/solus_crosscheck_$VDATE.log' ;
set echo on;
