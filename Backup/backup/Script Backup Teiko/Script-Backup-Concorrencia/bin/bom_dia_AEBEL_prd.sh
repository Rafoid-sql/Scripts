...
export SCRIPTLOG=/home/oracle/scripts/bin/logs/bom_dia_PRD_`date +'%d-%m-%Y'`.log
...
echo "********************************************************************************" >> $SCRIPTLOG
ls -lht /u02/prd/archives | head -50 >> $SCRIPTLOG
