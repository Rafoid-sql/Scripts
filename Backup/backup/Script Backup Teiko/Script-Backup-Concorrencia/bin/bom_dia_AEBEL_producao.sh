...
export SCRIPTLOG=/home/oracle/scripts/bin/logs/bom_dia_PRODUCAO_`date +'%d-%m-%Y'`.log
...
echo "********************************************************************************" >> $SCRIPTLOG
ls -lht /u02/producao/archives | head -50 >> $SCRIPTLOG
...
ASSUNTO="AEBEL-PRODUCAO | BOM DIA"
ANEXO="$SCRIPTLOG"
