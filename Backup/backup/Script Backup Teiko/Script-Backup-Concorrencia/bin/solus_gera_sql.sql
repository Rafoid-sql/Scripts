...
SPOOL '/home/oracle/scripts/bin/SOLUS_REMOVE_ARCHIVES.sh';
select 'asmcmd rm +data/solus/archivelog/'||B.NAME
from v$asm_file a
join v$asm_alias b on (a.group_number = b.group_number and
                       a.file_number = b.file_number)
where a.type = 'ARCHIVELOG' and b.name like '%983110371.arc'
