# Programa   : TkAtivaStandbyReadWrite.sh
# Funcao     : 1) Montar banco Standby
#              2) Faz Recover Completo
#              3) Abre o Banco em Modo Read Write
#
# Autor      : Paulo Cesar Schorr - Teiko
#            : Djalma Luciano Zendron - Teiko
# Data       : 04/03/2004
#            
# Sintaxe    : sh TKAtivaStandbyReadWrite.sh <OracleSid>
#
###############################################################################
F_Inicio(){
clear
...
F_Display "Ativando Banco em modo READ Write"
echo  "Etapa (1) - Montando o Database em modo READ Write!"
...
then
   STATUS=ERRO
   tk_severidade=2
   F_Display  "Erro, Etapa (1) - Finalizada com erro, verifique o AlertLog!"
   echo " 
Fim da Etapa (1), Com Erro!!! 
...
echo  "Etapa (2) - Iniciando o Database como Primario!!!"
$ORACLE_HOME/bin/sqlplus -s "/ as  sysdba" <<EOF
whenever sqlerror exit sql.sqlcode ;
set tab off
set pagesize 300
...
then
   STATUS=ERRO
   tk_severidade=2
   F_Display  "Erro, Etapa (2), Finalizada com problema, verifique AlertLog!!!"
   F_Notifica "Erro, Etapa (2), Finalizada com problema, verifique AlertLog!!!"
   echo " 
Fim da Etapa (2), Com Erro!!!
...
exit 1
   ...
   F_Display  "Sucesso..."
   echo " 
Fim do processo com Sucesso, Database Aberto como Primario!!! 
...
# Ativa o Banco em Modo Read Write
F_AtivaReadWrite
