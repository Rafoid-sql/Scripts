...
SPOOL CONSULTORIA_&SID_ORACLE2
...
COLUMN "COL5"  FORMAT 999,999,999,999 HEADING "TAMANHO"
...
SELECT INITCAP(RPAD(NAME,30,' ')||' = '|| RPAD(TO_CHAR(VALUE,'999,999,999,990'),30,' ')) "COL1"
FROM V$SYSSTAT
