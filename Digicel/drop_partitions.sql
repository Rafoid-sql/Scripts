...
DECLARE
  ...
  V_TABLE_COUNT NUMBER := 0;  -- Initialize counter
BEGIN
  ...
  -- Output the total number of tables processed
  DBMS_OUTPUT.PUT_LINE('');
  DBMS_OUTPUT.PUT_LINE('## TOTAL NUMBER OF TABLES PROCESSED: ' || V_TABLE_COUNT);
