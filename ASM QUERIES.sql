...
COL LABEL FOR A20
SELECT GROUP_NUMBER AS GN, NAME, FAILGROUP, MOUNT_STATUS, HEADER_STATUS, MODE_STATUS, LABEL, PATH, TOTAL_MB, FREE_MB, CREATE_DATE, MOUNT_DATE FROM V$ASM_DISK ORDER BY GN, NAME, LABEL, PATH;
/*
